...
// echo json_encode(array('status'=>0,'err'=> $openid));
// 			exit();
		...
		if ($uid) {
			...
			$err['status'] = $userinfo['class'];
			$err['class'] = $userinfo['class']==1 ? '代理用户' : '游客';
	...
	//  获取sessionkey 接口
	//  获取下面内容：
	//  {session_key: "i+D3Hs6/D2jPOyR4063DPA==", expires_in: 7200, openid: "o6Hvz0BBfdmlo_vaQ044NY-W5ydM"}
// expires_in
// :
// 7200
// openid
// :
// "o6Hvz0BBfdmlo_vaQ044NY-W5ydM"
// session_key
// :
// "i+D3Hs6/D2jPOyR4063DPA=="
	//***************************
...
//http://www.langrs.top/wechat/index.php/Api/Wxpay/notify
	//***************************
	//  获取sessionkey 接口
	//***************************
	//
	//
	public function getsessionkey1(){
		$wx_config = C('weixin');
    	$appid = $wx_config['appid1'];
    	$secret = $wx_config['secret1'];
